...
begin
  ...
  on conflict (user_id, candidate_company_id) do update set canonical_name = excluded.canonical_name, aliases = excluded.aliases, official_url = excluded.official_url, mypage_url = excluded.mypage_url, sender_domains = excluded.sender_domains, updated_at = now();
end $$;
