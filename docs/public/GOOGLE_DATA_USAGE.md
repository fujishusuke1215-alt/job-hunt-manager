...
> **公開前ドラフト**
> Google OAuth同意画面、本人用公開サイト、プライバシーポリシーへ掲載する説明の基礎資料です。公開サイトは架空demoとGoogle本人用を入口で分離します。実Googleアカウントでの試験、運営者情報の記入、Google API Services User Data Policyと法令の本人確認・必要な法的レビューが終わるまで完成版として公開しません。
